...
import { ArrowLeft, ArrowRight, Check, Clock, Phone, Search } from "lucide-react";
    ...
    <>
      <main className="flex min-h-svh flex-col">
        <section className="relative isolate overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-3xl px-5 pb-16 pt-24 text-center sm:px-8 sm:pt-28">
            <div className="pointer-events-none flex flex-col items-center">
              ...
              >
                ...
                as the destination. Your details stay saved in this browser, so
                you can come back and edit them any time.
              </p>
          ...
          <div className="mx-auto max-w-6xl">
            <header className="mx-auto max-w-2xl text-center">
              ...
              <h2 className="mt-3 text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
                What a recruiter wishes you knew.
              </h2>
              <p className="mt-3 text-base leading-relaxed text-muted-foreground">
                The CV is the easy half. These are the parts that decide whether
                it gets read.
              </p>
            </header>
